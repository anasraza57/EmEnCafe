...
else if(isset($_REQUEST['enquiryContact']))
{
	...
	$mailsubject = "You have a message by Website (Enquiries).";
...
else if(isset($_REQUEST['franchiseContact']))
{
	...
	$mailsubject = "You have a message by Website (Franchise).";
...
else if(isset($_REQUEST['brandContact']))
{
	...
	$mailsubject = "You have a message by Website (Brand Ambassador).";
...
else if(isset($_REQUEST['getInTouch']))
{
	...
	$mailsubject = "You have a message by Website (Get in Touch).";
